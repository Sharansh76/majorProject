            ...
            if (move_uploaded_file($resumeTmp, $resumePath)) {
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    try {
                        ...
                        $mail->SMTPAuth = true;
                        $mail->Username = 'boosttech.in@gmail.com'; // Replace with your email
                        $mail->Password = 'yuzc kdih zrwn djei'; // Replace with your email password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                        $mail->Port = 587;

                        // Applicant email
                        $mail->setFrom('boosttech.in@gmail.com', 'Boost Tech Job Portal');
                        ...
                        $mail->Body = "
                            ...
                            <p>Best regards,</p>
                            <p>Boost Tech Job Portal Team</p>
                        ";
                        $mail->send();

                        // Admin email
                        $mail->clearAddresses();
                        $mail->addAddress('boosttech.in@gmail.com'); // Replace with admin email
