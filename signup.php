...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'boosttech.in@gmail.com';
            $mail->Password = 'yuzc kdih zrwn djei';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            $mail->setFrom('boosttech.in@gmail.com', 'Boost Tech');
    ...
    <div id="BigBag">
        ...
        <div id="signup-rightBox">
            ...
            <form action="signup.php" method="POST" enctype="multipart/form-data" id="LoginLeftForm">
                ...
                <p class="terms">By clicking Sign Up, you agree to the Terms and Conditions & Privacy Policy of Boosttech.in</p>
